...
let g:template = {}
let g:template['c'] = {}
let g:template['c']['plan']="/* Yorvic Godoy\<cr>Descripcion:".g:rs."...".g:re." */\<cr>/*========================<Bibliotecas>=========================*/\<cr>#include <stdio.h>\<cr>#include <stdlib.h>\<cr>#include <math.h>\<cr>/*========================< Constantes >========================*/\<cr>".g:rs."...".g:re."\<cr>/*========================< Prototipos >========================*/\<cr>".g:rs."...".g:re."\<cr>/*========================<Funcion Main>========================*/\<cr>int main(){\<cr>".g:rs."...".g:re."\<cr>\<left>return 0;\<cr>}"
...
let g:template['c']['fun'] = "\<cr>/*========================<".g:rs."...".g:re.">========================*/\<cr>".g:rs."...".g:re." ".g:rs."...".g:re." (".g:rs."...".g:re."){\<cr>".g:rs."...".g:re."\<cr>\<left>return ".g:rs."...".g:re.";\<cr>}"
let g:template['c']['ppro'] = "void ".g:rs."...".g:re." (".g:rs."...".g:re.");"
let g:template['c']['lpro'] = "".g:rs."...".g:re." (".g:rs."...".g:re.");"
let g:template['c']['pro'] = "\<cr>/*========================<".g:rs."...".g:re.">========================*/\<cr>void ".g:rs."...".g:re." (".g:rs."...".g:re."){\<cr>".g:rs."...".g:re."\<cr>}""
...
let g:template['c']['for'] = "for( ".g:rs."...".g:re." ; ".g:rs."...".g:re." ; ".g:rs."...".g:re." ){\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['main'] = "int main(){\<cr>".g:rs."...".g:re."\<cr>\<left>return 0;\<cr>}"
